...
NODOS = { 0: Nodo("Estas en tu habitación, lleno de lujos disfrutando tu delicioso almuerzo. La vida es buena.",
          ...
          26: Nodo("Entre los hombres que aparecen se presenta uno particularmente misterioso, Mart, afirma que puede ayudar bastante, "
                   "pues tiene experiencia militar para entrenar a tus seguidores. Mas, nadie sabe de donde ha salido, parece alguien confiado de sí mismo.\n"
                   "Te pide dejarle dirigir el entrenamiento. No parece dispuesto a irse...",
                   [Path(27, "Le permites ayudarte con el entrenamiento de la gente"), Path(30, "No le confias algo tan importante pero le permites quedarse")]),
          27: Nodo("Han pasado unos meses de arduo entrenamiento, haz compartido, sufrido y superados obstaculos junto a tus camaradas, Mart ha sido"
                   " de gran ayuda, habeis forjado una buena amistad con él, confias en él pero siempre tiene un aire de misterio.\n"
                   "Finalmente se preparan para marchar al palacio, pero Mart te dice que tiene asuntos que hacer y debe marcharse antes,"
                   "te dice que confies en él y se va con una sonrisa que no termina de agradarte...",
          ...
          19: Nodo("Te quedas festejando con todos y te unes a la fiesta que estaba formandose",
                  [Path(20, "Continuar")]),
          ...
          22: Nodo("Sientes que no puedes contra él, repentinamente aparece Mart quien en un ataque suicida hacia el heroe enemigo generando una ventana y permitiendote contratacar ganando la batalla",
                  [Path(24, "Asistir a Mart")]),
          23: Nodo("Mientras llamas por ayuda los ataques del heroe rival te dejan sin aliento. Por suerte, tus gritos fueron escuchados, es Mart quien se interpone entre tu y el ataque rival recibiendo una herida pero permitiendote contratacar y ganar la batalla",
                  [Path(24, "Asistir a Mart")]),
          24: Nodo("Con sus ultimas palabras, te dice que fue un honor haberte conocido y que ahora si eres un heroe de verdad al haber confiado en él. Te das cuenta que él enterfirió en las formaciones"
                   " del enemigo para que pudiesen ganar... Te despides de él entre lagrimas",
                  [Path(25, "Terminar tu misión")]),
          25: Nodo("Unificas Zarene y Cinait. Ganaste",
                  []),
          ###
          30: Nodo("Han pasado unos meses de arduo entrenamiento, haz compartido, sufrido y superados obstaculos junto a tus camaradas, Mart ha intentado"
          ...
          36: Nodo("Entre las sombras, vez una silueta. Es el heroe del otro reino quien ha caido en la locura y te ataca. Apenas logras defenderte",
                  [Path(37, "luchar"), Path(38, "llamar por ayuda")]),
          37: Nodo("Sientes que no puedes contra él, repentinamente aparece Mart quien en un ataque suicida hacia el heroe enemigo generando una ventana y permitiendote contratacar, "
                   "sin embargo su sincronización contigo no ha sido buena... esto ha sido en vano...",
                  [Path(15, "Continuar luchando.")]),
          38: Nodo("Mientras llamas por ayuda los ataques del heroe rival te dejan sin aliento. Repentinamente aparece Mart!, el maldito logró escabullirse... "
                   "Para tu sorpresa se coloca a tu lado apuntando su espada a tu enemigo.\n"
                   "Luchan contra el héroe enemigo pero tu y Mart no tienen buena sincronización... si tan solo...\n"
                   "Debido a esto y al canzancio el enemigo apuñala a Mart en un descuido.",
                  [Path(39, "Continuar luchando")]),
          39: Nodo("Debido al cansancio acumulado en tí, no eres capaz de super al enemigo, repentinamente eres atravezado por"
                   " su espada...",
                  [Path(15, "Continuar...")]),
          }