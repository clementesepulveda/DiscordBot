...
NODOS = { 0: Nodo("Estas en tu habitación, lleno de lujos disfrutando tu delicioso almuerzo. Todo esto es gracias a tu padre, el héroe del reino "
          ...
          4: Nodo("Te informan que tu padre, el héroe del reino ha sido asesinado. De alguna forma encuentras las fuerzas para volver a tu cuarto. Sientes que el mundo da vueltas a tu alrededor, la temperatura desciende súbitamente, y la comida que acabas de consumir parece revolverse en tu estómago.",
                  [Path(5, "Te preparas para pelear, quien sea el culpable de esto pagará"), Path(6, "Pones pestillo y comienzas a meditar sobre la razón del asesinato")]),
          5: Nodo("Mientras te preparas escuchas a alguien tocar la puerta",
                  [Path(8, "Abres la puerta"), Path(15, "Ignoras el llamado. ¿Quien podría molestar en un momento así?r")]),
          ...
          7: Nodo("Te tumbas en tu cama y dejas que el sueño se lleve tu pesadumbre. No sabes cuanto tiempo ha pasado, despiertas con el mismo cansancio con el que empezaste a dormir, no tienes energías para poner un pie afuera. Fuiste envenenado mientras dormías y mueres.",
                  []),
          8: Nodo("En el umbral de la puerta aparece una figura con el semblante sombrío, te dice que su nombre es Adeltor. Te cuenta que es amigo de tu padre, que lo están persiguiendo no tiene mucho tiempo, menciona algo sobre una organización secreta y siniestra, pero no terminas de entender. Adeltor mira con miedo hacia tu ventana, y corre despavorido. Sientes que te falta el aire, que toda tu habitación es un recordatorio de una gran mentira. Adeltor te dice que debes abandonar rápidamente la ciudad",
                  [Path(9, "Tomas un abrigo y sales de tu habitación")]),
          9: Nodo("Sales de tu casa, y de la ciudad que te vio nacer, caminas sin rumbo fijo. Avanzas atormentado por tus pensamientos, ciego al mundo que te rodea. Unas figuras te cortan el paso y te sacan de tu sopor, es una pandilla de bandidos. El pueblo más cercano es apenas visible, ¿cómo te defenderás?",
                  [Path(10, "Ataque de fuego"), Path(10, "Ataque de hielo"), Path(11, "Usar tu espada")]),
          10: Nodo("...Este poder no parece funcionar. Estás demasiado debil",
                  [Path(9, "Intentar un nuevo ataque")]),
          11: Nodo("Tu espada se rompe y la pandilla te golpea hasta dejarte en el suelo, inconsciente. Estabas demasiado debilitado para pelear. Un aparente aldeano pasa por la carretera a tu costado, no tienes ninguna de las cosas que traías. Apenas tienes un poco de ropa pero lograste arrastrarte hasta un lugar seguro al costado del camino",
                  [Path(40, "Los daños no son severos así que buscas descansar donde estás unos minutos para recuperarte"), Path(12, "Con todas tus fuerzas llamas la atención del aldeano")]),
          ...
          29: Nodo("Al iniciar la batalla, pierdes de vista a Mart de inmediato, decides concentrarte en la batalla, "
                  ...
                  [Path(17, "Rechazar el canto y lideras la exploración del palacio"), Path(19, "El grupo necesita relajarse, asumir la posición de héroe y unirte al festejo")]),
          ...
          18: Nodo("Ingresas a una habitación oscura ubicada en el extremo del palacio. Con la poca luz ingresando a través de las cortinas vez algo brillante en el suelo",
                  [Path(20, "Recoger objeto brillante"), Path(21, "Esperas unos segundos para que tus ojos se ajusten a la oscuridad")]),
          19: Nodo("Te quedas festejando con todos y te unes a la fiesta que estaba formándose",
                  [Path(20, "Continuar")]),
          20: Nodo("Sin notarlo, el héroe del otro reino ha caído en la locura y te ataca con una daga envenenada por la espalda. Comienzas a perder el conocimiento y luego de unos segundos tu vida termina.",
                  []),
          ...
          22: Nodo("Sientes que no puedes contra él, repentinamente aparece Mart quien realiza un ataque suicida hacia el héroe enemigo generando una ventana y permitiéndote contratacar ganando la batalla",
          ...
          23: Nodo("Mientras llamas por ayuda los ataques del héroe rival te dejan sin aliento. Por suerte, tus gritos fueron escuchados, es Mart quien se interpone entre tu y el ataque rival recibiendo una herida pero permitiéndote contratacar y ganar la batalla",
                  [Path(24, "Asistir a Mart")]),
          24: Nodo("La herida es grave. Con sus últimas palabras, te dice que fue un honor haberte conocido y que ahora si eres un héroe de verdad al haber confiado en él. Te das cuenta de que él interfirió en las formaciones"
                   " del enemigo para que pudiesen ganar... Te despides de él entre lágrimas",
                  [Path(25, "Terminar tu misión")]),
          25: Nodo("Con el palacio limpio de enemigos y la lucha terminada, decides revelar públicamente la verdad sobre el heroe y la organización. Declaras que Zarene y Cinait deben trabajar juntas por el bien de ambos reinos.\n"
                   "Con la ayuda de la ciudad y tus nuevos amigos, un consejo se forma para dirigir la ciudad hasta lograr la tan anhelada paz. Has triunfado en tu misión.",
                  []),
          ###
          ...
          32: Nodo("Emprendes la retirada, pero tus hombres con esta orden han perdido la moral y retroceden desorganizados, las fuerzas enemigas "
                   "les dan alcance.",
                   [Path(15, " Decides utilizar formaciones originales que no haya visto Mart.")]),
          33: Nodo("Al iniciar la batalla, pierdes de vista a Mart de inmediato, decides concentrarte en la batalla, "
                   "Luego de horas de batallas logran superar con dificultad al enemigo y, "
          ...
          35: Nodo("Ingresas a una habitación oscura ubicada en el extremo del palacio. Con la poca luz ingresando a través de las cortinas vez algo brillante en el suelo",
                  [Path(20, "Recoger objeto brillante"), Path(36, "Esperar unos segundos para ajustar tus ojos a la oscuridad")]),
          ...
          38: Nodo("Mientras llamas por ayuda los ataques del héroe rival te dejan sin aliento. Repentinamente aparece Mart!, el maldito logró escabullirse... "
                   ...
                   "Luchan contra el héroe enemigo pero tú y Mart no tienen buena sincronización... si tan solo hubiesen entrenado más juntos como Mart sugería...\n"
          ...
          39: Nodo("Debido al cansancio acumulado en tí, no eres capaz de super al enemigo, repentinamente eres atravesado por"
                   " su espada...",
                  [Path(15, "Continuar...")]),
          40: Nodo("Al intentar pararte notas que no puedes, tus piernas estaban entumecidas, seguramente te inyectaron algun paralizante luego del ataque. Sin nadie pasando por el camino te encuentras solo. Con el paso del tiempo llega la noche y aún no puedes moverte a libertad. Unos lobos salvajes aparecen y deciden que serás su cena, es el fin de tu aventura.",
                   []),
          }
